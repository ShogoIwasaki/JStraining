...
describe("Complex number operations", () => {
  describe("add function", () => {
    ...
    it("correctly add two complex numbers", () => {
      expect(add({ real: 1, imag: 2 }, { real: 3, imag: 4 })).toEqual({
        real: 4,
        imag: 6,
      });
    });
    ...
    it("correctly add when real parts are zero", () => {
      expect(add({ real: 0, imag: 2 }, { real: 0, imag: 4 })).toEqual({
        real: 0,
        imag: 6,
      });
    });
    ...
    it("correctly add when imaginary parts are zero", () => {
      expect(add({ real: 1, imag: 0 }, { real: 3, imag: 0 })).toEqual({
        real: 4,
        imag: 0,
      });
    });
  ...
  describe("sub function", () => {
    ...
    it("correctly subtract two complex numbers", () => {
      expect(sub({ real: 1, imag: 2 }, { real: 3, imag: 4 })).toEqual({
        real: -2,
        imag: -2,
      });
    });
    ...
    it("correctly subtract when real parts are zero", () => {
      expect(sub({ real: 0, imag: 4 }, { real: 0, imag: 2 })).toEqual({
        real: 0,
        imag: 2,
      });
    });
    ...
    it("correctly subtract when imaginary parts are zero", () => {
      expect(sub({ real: 3, imag: 0 }, { real: 1, imag: 0 })).toEqual({
        real: 2,
        imag: 0,
      });
    });
  ...
  describe("mul function", () => {
    ...
    it("correctly multiply two complex numbers", () => {
      expect(mul({ real: 1, imag: 2 }, { real: 3, imag: 4 })).toEqual({
        real: -5,
        imag: 10,
      });
    });
    ...
    it("correctly multiply when real parts are zero", () => {
      expect(mul({ real: 0, imag: 4 }, { real: 0, imag: 2 })).toEqual({
        real: -8,
        imag: 0,
      });
    });
    ...
    it("correctly multiply when imaginary parts are zero", () => {
      expect(mul({ real: 3, imag: 0 }, { real: 1, imag: 0 })).toEqual({
        real: 3,
        imag: 0,
      });
    });
  ...
  describe("div function", () => {
    ...
    it("correctly divide two complex numbers", () => {
      expect(div({ real: 1, imag: 2 }, { real: 3, imag: 4 })).toEqual({
        real: 0.44,
        imag: 0.08,
      });
    });
    ...
    it("throw an error when dividing by zero", () => {
      expect(() => div({ real: 1, imag: 2 }, { real: 0, imag: 0 })).toThrow(
        "Division by zero is not allowed in complex numbers."
      );
    });
  });
});
